...
eigenvals = sort(hg_calcEigVals(struct_cube_msk, xspac, yspac, zspac));
...
eigenvals = hg_calcEigVals( struct_cube_mask, xspac, yspac, zspac );
...
eigvals = hg_calcEigVals( struct_cube_mask, xspac, yspac, zspac );
...
[~,covmat] = hg_calcEigVals(struct_cube_mask, xspac, yspac, zspac);
volume = calc_volume(struct_cube_mask, xspac, yspac, zspac);
...
eigenvals = hg_calcEigVals(struct_cube_msk, xspac, yspac, zspac);
